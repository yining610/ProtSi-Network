...
class Dataset:
    ...
    '''
    def __init__(self, question_set, set=None):
        ...
        if set=='train':
            answer,_,score,_ = train_test_split(answer, score, test_size=0.2, random_state=42)
            answer,_,score,_ = train_test_split(answer, score, test_size=0.2, random_state=42)
        elif set=='test':
            _,answer,_,score = train_test_split(answer, score, test_size=0.2, random_state=42)
        elif set=='validation':
            answer,_,score,_ = train_test_split(answer, score, test_size=0.2, random_state=42)
            _,answer,_,score = train_test_split(answer, score, test_size=0.2, random_state=42)
